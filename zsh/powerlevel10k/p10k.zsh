# Generated by Powerlevel10k configuration wizard on 2022-07-30 at 23:04 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND='#2A303C'

  # Separator between same-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%4F'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%4F'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=200
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=200
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=200
